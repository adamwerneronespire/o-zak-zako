*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/ADONEM_ONRV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/ADONEM_ONRV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/ADONEM_ONRV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/ADONEM_ONRV_EXTRACT
TOTAL = /ZAK/ADONEM_ONRV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/ADONEM_ONRV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/ADONEM_ONRV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ADONEM_ONRV_EXTRACT
TOTAL = /ZAK/ADONEM_ONRV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/ADONEM_ONRV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/ADONEM_ONRV'
...
TOTAL = /ZAK/ADONEM_ONRV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/ADONEM_ONRV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/ADONEM_ONRV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/ADONEM_ONRV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/ADONEM_ONRV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ADONEM_ONRV_EXTRACT
TOTAL = /ZAK/ADONEM_ONRV_TOTAL
