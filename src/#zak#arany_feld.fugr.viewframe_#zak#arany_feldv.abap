*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/ARANY_FELDV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/ARANY_FELDV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_FELDV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/ARANY_FELDV_EXTRACT
TOTAL = /ZAK/ARANY_FELDV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_FELDV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/ARANY_FELDV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ARANY_FELDV_EXTRACT
TOTAL = /ZAK/ARANY_FELDV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/ARANY_FELDV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_FELDV'
...
TOTAL = /ZAK/ARANY_FELDV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/ARANY_FELDV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/ARANY_FELDV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_FELDV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/ARANY_FELDV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ARANY_FELDV_EXTRACT
TOTAL = /ZAK/ARANY_FELDV_TOTAL
