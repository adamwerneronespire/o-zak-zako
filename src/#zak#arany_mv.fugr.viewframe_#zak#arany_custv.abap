*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/ARANY_CUSTV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/ARANY_CUSTV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_CUSTV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/ARANY_CUSTV_EXTRACT
TOTAL = /ZAK/ARANY_CUSTV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_CUSTV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/ARANY_CUSTV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ARANY_CUSTV_EXTRACT
TOTAL = /ZAK/ARANY_CUSTV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/ARANY_CUSTV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_CUSTV'
...
TOTAL = /ZAK/ARANY_CUSTV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/ARANY_CUSTV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/ARANY_CUSTV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/ARANY_CUSTV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/ARANY_CUSTV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ARANY_CUSTV_EXTRACT
TOTAL = /ZAK/ARANY_CUSTV_TOTAL
