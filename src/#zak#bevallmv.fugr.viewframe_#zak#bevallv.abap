*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/BEVALLV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/BEVALLV       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/BEVALLV_EXTRACT
TOTAL = /ZAK/BEVALLV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/BEVALLV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/BEVALLV_EXTRACT
TOTAL = /ZAK/BEVALLV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/BEVALLV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLV'
...
TOTAL = /ZAK/BEVALLV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/BEVALLV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/BEVALLV-UPD_FLAG NE SPACE.
