*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/BEVALLP_MV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/BEVALLP_MV     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLP_MV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/BEVALLP_MV_EXTRACT
TOTAL = /ZAK/BEVALLP_MV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLP_MV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/BEVALLP_MV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/BEVALLP_MV_EXTRACT
TOTAL = /ZAK/BEVALLP_MV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/BEVALLP_MV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLP_MV'
...
TOTAL = /ZAK/BEVALLP_MV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/BEVALLP_MV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/BEVALLP_MV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/BEVALLP_MV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/BEVALLP_MV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/BEVALLP_MV_EXTRACT
TOTAL = /ZAK/BEVALLP_MV_TOTAL
