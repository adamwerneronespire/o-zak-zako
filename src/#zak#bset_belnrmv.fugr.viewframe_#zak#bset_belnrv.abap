*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/BSET_BELNRV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/BSET_BELNRV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/BSET_BELNRV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/BSET_BELNRV_EXTRACT
TOTAL = /ZAK/BSET_BELNRV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/BSET_BELNRV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/BSET_BELNRV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/BSET_BELNRV_EXTRACT
TOTAL = /ZAK/BSET_BELNRV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/BSET_BELNRV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/BSET_BELNRV'
...
TOTAL = /ZAK/BSET_BELNRV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/BSET_BELNRV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/BSET_BELNRV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/BSET_BELNRV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/BSET_BELNRV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/BSET_BELNRV_EXTRACT
TOTAL = /ZAK/BSET_BELNRV_TOTAL
