class /ZAK/CL_IM_AK_FI_TAX_BADI_015 definition
  public
  final
  create public .

*"* public components of class /ZAK/CL_IM_AK_FI_TAX_BADI_015
*"* do not include other source files here!!!
public section.

  interfaces IF_EX_FI_TAX_BADI_015 .
protected section.
*"* protected components of class /ZAK/CL_IM_AK_FI_TAX_BADI_015
*"* do not include other source files here!!!
private section.
*"* private components of class /ZAK/CL_IM_AK_FI_TAX_BADI_015
*"* do not include other source files here!!!
ENDCLASS.



CLASS /ZAK/CL_IM_AK_FI_TAX_BADI_015 IMPLEMENTATION.
...
method IF_EX_FI_TAX_BADI_015~SET_FLAG_USE_BADI_15.
* ...
   CH_USE_BADI_15 = 'X'.
endmethod.
ENDCLASS.
