...
* A0GD0209DA
  PERFORM get_onrev_calc TABLES t_bevallo
                                li_last_bevallo
                                t_bevallb
                         USING  c_abevaz_a0gd0209da   "Módosított mező
...
* A0GD0219AA
  PERFORM get_onrev_calc TABLES t_bevallo
                                li_last_bevallo
                                t_bevallb
                         USING  c_abevaz_a0gd0219aa   "Módosított mező
...
* A0GD0220DA
  PERFORM get_onrev_calc TABLES t_bevallo
                                li_last_bevallo
                                t_bevallb
                         USING  c_abevaz_a0gd0220da   "Módosított mező
...
* A0GD0220CA
  PERFORM get_onrev_div TABLES t_bevallo
                               t_bevallb
                        USING  c_abevaz_a0gd0220ca   "Módosított mező
                               c_abevaz_a0gd0220da
                               '0.13'.
* A0GD0191DA
  REFRESH lr_abevaz.
