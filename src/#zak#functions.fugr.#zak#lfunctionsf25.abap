...
* A0HD0205DA
  PERFORM GET_ONREV_CALC TABLES T_BEVALLO
                                LI_LAST_BEVALLO
                                T_BEVALLB
                         USING  'A0HD0205DA'   "Módosított mező
                                'A0FC0150CA'   "Forrás 1
                                SPACE          "Forrás 2
                                SPACE          "Forrás 3
                                SPACE          "Forrás 4
...
* A0HD0205CA
  PERFORM GET_ONREV_DIV TABLES T_BEVALLO
                               T_BEVALLB
                        USING  'A0HD0205CA'   "Módosított mező
                               'A0HD0205DA'
                               '0.04'.
* A0HD0206DA
  PERFORM GET_ONREV_CALC TABLES T_BEVALLO
...
*                                LI_LAST_BEVALLO
*                                T_BEVALLB
*                         USING  'A0HD0212AA'   "Módosított mező
*                                'A0FC0158CA'   "Forrás 1
*                                SPACE          "Forrás 2
*                                SPACE          "Forrás 3
*                                SPACE          "Forrás 4
...
* A0HD0213DA
  PERFORM GET_ONREV_CALC TABLES T_BEVALLO
                                LI_LAST_BEVALLO
                                T_BEVALLB
                         USING  'A0HD0213DA'   "Módosított mező
                                'A0FC0136CA'   "Forrás 1
                                SPACE          "Forrás 2
                                SPACE          "Forrás 3
                                SPACE          "Forrás 4
...
* A0HD0214CA
  PERFORM GET_ONREV_DIV TABLES T_BEVALLO
                               T_BEVALLB
                        USING  'A0HD0214CA'   "Módosított mező
                               'A0HD0214DA'
                               '0.185'.
* A0HD0215DA
  PERFORM GET_ONREV_CALC TABLES T_BEVALLO
...
* A0HD0215CA
  PERFORM GET_ONREV_DIV TABLES T_BEVALLO
                               T_BEVALLB
                        USING  'A0HD0215CA'   "Módosított mező
                               'A0HD0215DA'
                               '0.185'.
* A0HD0194DA
  REFRESH LR_ABEVAZ.
...
* A0ID0250CA
  PERFORM GET_ONREV_CALC TABLES T_BEVALLO
                                LI_LAST_BEVALLO
                                T_BEVALLB
                         USING  'A0ID0250CA'   "Módosított mező
                                'A0FC0159CA'   "Forrás 1
                                SPACE          "Forrás 2
                                SPACE          "Forrás 3
                                SPACE          "Forrás 4
