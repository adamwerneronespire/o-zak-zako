*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/ONELL_BOOKV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/ONELL_BOOKV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/ONELL_BOOKV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/ONELL_BOOKV_EXTRACT
TOTAL = /ZAK/ONELL_BOOKV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/ONELL_BOOKV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/ONELL_BOOKV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ONELL_BOOKV_EXTRACT
TOTAL = /ZAK/ONELL_BOOKV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/ONELL_BOOKV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/ONELL_BOOKV'
...
TOTAL = /ZAK/ONELL_BOOKV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/ONELL_BOOKV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/ONELL_BOOKV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/ONELL_BOOKV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/ONELL_BOOKV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/ONELL_BOOKV_EXTRACT
TOTAL = /ZAK/ONELL_BOOKV_TOTAL
