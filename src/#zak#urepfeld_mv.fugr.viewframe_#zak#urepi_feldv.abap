*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/UREPI_FELDV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/UREPI_FELDV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/UREPI_FELDV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/UREPI_FELDV_EXTRACT
TOTAL = /ZAK/UREPI_FELDV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/UREPI_FELDV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/UREPI_FELDV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/UREPI_FELDV_EXTRACT
TOTAL = /ZAK/UREPI_FELDV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/UREPI_FELDV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/UREPI_FELDV'
...
TOTAL = /ZAK/UREPI_FELDV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/UREPI_FELDV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/UREPI_FELDV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/UREPI_FELDV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/UREPI_FELDV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/UREPI_FELDV_EXTRACT
TOTAL = /ZAK/UREPI_FELDV_TOTAL
