*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ZAK/VPOP_LIFNRV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ZAK/VPOP_LIFNRV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ZAK/VPOP_LIFNRV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ZAK/VPOP_LIFNRV_EXTRACT
TOTAL = /ZAK/VPOP_LIFNRV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ZAK/VPOP_LIFNRV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ZAK/VPOP_LIFNRV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/VPOP_LIFNRV_EXTRACT
TOTAL = /ZAK/VPOP_LIFNRV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ZAK/VPOP_LIFNRV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ZAK/VPOP_LIFNRV'
...
TOTAL = /ZAK/VPOP_LIFNRV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ZAK/VPOP_LIFNRV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ZAK/VPOP_LIFNRV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ZAK/VPOP_LIFNRV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ZAK/VPOP_LIFNRV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ZAK/VPOP_LIFNRV_EXTRACT
TOTAL = /ZAK/VPOP_LIFNRV_TOTAL
